...
################################################################################
## Form generated from reading UI file 'DogeAutoSubLbhLmT.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.verticalLayout.addWidget(self.output_file_label)
        ...
        self.verticalLayout.addWidget(self.output_file_path_display)
