...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        mlaasLayout.setContentsMargins(8, 4, 8, 4)
        mlaasLayout.setSpacing(2)
        ...
        tokenRow.addWidget(self.mlaasTokenInput)
        ...
        self.getTokenBtn.setMinimumHeight(8)
        tokenRow.addWidget(self.getTokenBtn)

        mlaasLayout.addLayout(tokenRow)
