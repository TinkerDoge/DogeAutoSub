...
def main():
    ...
    parser.add_argument("--model", required=False, help="Input *.pbmm model file",default="model\model.tflite")
    parser.add_argument("--scorer", required=False, help="Input *.scorer file", default="model\huge-vocabulary.scorer")
